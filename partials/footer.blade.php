		...
		<div class="menu" style="width: 163px;">
			...
			<p class="social" style="">
				...
				@if($kontak->fb)
					...
					<a style="background:none" target="_blank" href="{{$kontak->fb}}"><img src="{{URL::to(dirTemaToko().'callisto/assets/images/ico-facebook-1.png')}}" alt="Facebook" width="23" height="21" /></a>

				@endif

				@if($kontak->tw)

					<a style="background:none" target="_blank" href="{{$kontak->tw}}"><img src="{{URL::to(dirTemaToko().'callisto/assets/images/ico-twitter-1.png')}}" alt="Twitter" width="23" height="21" /></a>
